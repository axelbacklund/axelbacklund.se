...
i.e. a function that updates the struct’s `loadingProgress` variable when loading, and when done, it returns an optional UIImage. In the UI, it looks like this:

![Simulator Screen Recording - iPhone 14 Pro - 2023-01-06 at 21.07.21.gif](images/Simulator_Screen_Recording_-_iPhone_14_Pro_-_2023-01-06_at_21.07.21.gif)
